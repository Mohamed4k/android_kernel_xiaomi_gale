...
static void e1000e_dump(struct e1000_adapter *adapter)
{
	...
	dev_dbg(&adapter->pdev->dev, "Tx Ring Summary\n");
	...
	dev_dbg(&adapter->pdev->dev, "Tx Ring Dump\n");
...
rx_ring_summary:
	dev_dbg(&adapter->pdev->dev, "Rx Ring Summary\n");
	...
	dev_dbg(&adapter->pdev->dev, "Rx Ring Dump\n");
...
static void __e1000e_disable_aspm(struct pci_dev *pdev, u16 state, int locked)
{
	...
	dev_dbg(&pdev->dev, "Disabling ASPM %s %s\n",

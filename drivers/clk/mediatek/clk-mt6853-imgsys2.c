...
static int clk_mt6853_imgsys2_probe(struct platform_device *pdev)
{
...
static const struct of_device_id of_match_clk_mt6853_imgsys2[] = {
	{ .compatible = "mediatek,mt6853-imgsys2", },
	{}
};

#if MT_CLKMGR_MODULE_INIT

static struct platform_driver clk_mt6853_imgsys2_drv = {
	.probe = clk_mt6853_imgsys2_probe,
	.driver = {
		.name = "clk-mt6853-imgsys2",
		.of_match_table = of_match_clk_mt6853_imgsys2,
	},
};

builtin_platform_driver(clk_mt6853_imgsys2_drv);

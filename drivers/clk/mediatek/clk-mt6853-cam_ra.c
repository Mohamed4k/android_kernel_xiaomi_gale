...
static int clk_mt6853_cam_ra_probe(struct platform_device *pdev)
{
...
static const struct of_device_id of_match_clk_mt6853_cam_ra[] = {
	{ .compatible = "mediatek,mt6853-camsys_rawa", },
	{}
};

#if MT_CLKMGR_MODULE_INIT

static struct platform_driver clk_mt6853_cam_ra_drv = {
	.probe = clk_mt6853_cam_ra_probe,
	.driver = {
		.name = "clk-mt6853-cam_ra",
		.of_match_table = of_match_clk_mt6853_cam_ra,
	},
};

builtin_platform_driver(clk_mt6853_cam_ra_drv);

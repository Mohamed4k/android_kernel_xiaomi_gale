...
#include "s5kjns_truly_main_iii_mipi_raw.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJNS_TRULY_MAIN_III_SENSOR_ID ,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_s5kjnstruly[] = {
	//0x6028,0x2400,
	/*
	0x602A,0x7700,
	0x6F12,0x1753,
...
static void sensor_init(void)
{
	...
	//mdelay(10);
		...
		addr_data_pair_init_s5kjnstruly,
		sizeof(addr_data_pair_init_s5kjnstruly) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_s5kjnstruly[] = {
    0x6028,0x2400,
    0x602A,0x1A28,
    0x6F12,0x4C00,
    0x602A,0x065A,
...
static void preview_setting(void)
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_preview_s5kjnstruly,
		sizeof(addr_data_pair_preview_s5kjnstruly) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_s5kjnstruly[] = {
    0x6028,0x2400,
    0x602A,0x1A28,
    0x6F12,0x4C00,
    0x602A,0x065A,
...
static void hs_video_setting(void) /// 120fps
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_hs_video_s5kjnstruly,
		sizeof(addr_data_pair_hs_video_s5kjnstruly) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_s5kjnstruly[] = {
    0x6028,0x2400,
    0x602A,0x1A28,
    0x6F12,0x4C00,
    0x602A,0x065A,
...
static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("start\n");
        s5kjns_multi_write_cmos_sensor(
		addr_data_pair_capture_s5kjnstruly,
		sizeof(addr_data_pair_capture_s5kjnstruly) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_s5kjnstruly[] = {
    0x6028,0x2400,
    0x602A,0x1A28,
    0x6F12,0x4C00,
    0x602A,0x065A,
...
static void normal_video_setting(kal_uint16 currefps)  // 30fps
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_normal_video_s5kjnstruly,
		sizeof(addr_data_pair_normal_video_s5kjnstruly) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_s5kjnstruly[] = {
    0x6028,0x2400,
    0x602A,0x1A28,
    0x6F12,0x4C00,
    0x602A,0x065A,
...
static void slim_video_setting(void) //60fps
{
	LOG_INF("E\n");
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_slim_video_s5kjnstruly,
		sizeof(addr_data_pair_slim_video_s5kjnstruly) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_s5kjnstruly[] = {
    0x6028,0x2400,
    0x602A,0x1A28,
    0x6F12,0x4C00,
    0x602A,0x065A,
...
static void custom1_setting(void)
{
	LOG_INF("E\n");
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_custom1_s5kjnstruly,
		sizeof(addr_data_pair_custom1_s5kjnstruly) / sizeof(kal_uint16));
}
			...
			if (vendor_id == 0x09) {
				*sensor_id = return_sensor_id()+1;
				...
				if (*sensor_id == imgsensor_info.sensor_id) {
					pr_debug("s5kjns_truly i2c 0x%x, sid 0x%x\n",
...
// #if MULTI_WRITE
// kal_uint16 addr_data_pair_set_test_pattern_s5kjnstruly[] = {
// 	0x0200,0x0002,
// 	0x0202,0x0002,
// 	0x0204,0x0020,
// 	0x020E,0x0100,
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {
		...
		// s5kjns_multi_write_cmos_sensor(
		// addr_data_pair_set_test_pattern_s5kjnstruly,
		// sizeof(addr_data_pair_set_test_pattern_s5kjnstruly) / sizeof(kal_uint16));
...
UINT32 S5KJNS_TRULY_MAIN_III_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	//LOG_INF("S5KJNS_TRULY_MAIN_III_MIPI_RAW_SensorInit in\n");

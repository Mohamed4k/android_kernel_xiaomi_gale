...
#include "sc202cs_aac_marco_ii_mipi_raw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = { 
    .sensor_id = SC202CS_AAC_MARCO_II_SENSOR_ID,
...
UINT32 SC202CS_AAC_MARCO_II_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{

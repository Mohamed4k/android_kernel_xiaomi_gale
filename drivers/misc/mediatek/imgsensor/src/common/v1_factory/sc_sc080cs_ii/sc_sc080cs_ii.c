...
static unsigned char sc080cs_i2c_read(struct sc080cs *sc080cs, int address)
{
	...
	while (retry > 0)
	{
		...
		qvga_dev_err(&client->dev, "zaki sc080 ret=%d buf=0x%x\n",ret,i2c_buf[0]);
		if (retry >0)
		{
			//mdelay(20);
            if(ret < 0){
		        qvga_dev_err(&client->dev, "zaki sc080 read failed! ret=%d \n",ret);
...
void sc080cs_Init(struct sc080cs *sc080cs)
{
	...
	sc080cs_i2c_write(sc080cs, 0x3213,0x08);
	sc080cs_i2c_write(sc080cs, 0x3301,0x04);
	sc080cs_i2c_write(sc080cs, 0x3305,0x00);
	sc080cs_i2c_write(sc080cs, 0x3306,0x0a);
	sc080cs_i2c_write(sc080cs, 0x330a,0x00);
	sc080cs_i2c_write(sc080cs, 0x330b,0x3e);
	sc080cs_i2c_write(sc080cs, 0x3333,0x10);
	sc080cs_i2c_write(sc080cs, 0x3334,0x40);
	sc080cs_i2c_write(sc080cs, 0x33b3,0x30);
	sc080cs_i2c_write(sc080cs, 0x349f,0x02);
	sc080cs_i2c_write(sc080cs, 0x34a6,0x03);
	sc080cs_i2c_write(sc080cs, 0x34a7,0x07);
	sc080cs_i2c_write(sc080cs, 0x34a8,0x2a);
	sc080cs_i2c_write(sc080cs, 0x34a9,0x2a);
	sc080cs_i2c_write(sc080cs, 0x34e9,0x2a);
	sc080cs_i2c_write(sc080cs, 0x34f8,0x07);
	sc080cs_i2c_write(sc080cs, 0x3630,0x75);
	sc080cs_i2c_write(sc080cs, 0x363a,0xe0);
	sc080cs_i2c_write(sc080cs, 0x3670,0x03);
	sc080cs_i2c_write(sc080cs, 0x3674,0x85);
	sc080cs_i2c_write(sc080cs, 0x3675,0x45);
	sc080cs_i2c_write(sc080cs, 0x3676,0x45);
	...
	sc080cs_i2c_write(sc080cs, 0x5170,0x2b);
	sc080cs_i2c_write(sc080cs, 0x518d,0x02);
	sc080cs_i2c_write(sc080cs, 0x518e,0xc6);
				...
				struct device_attribute *attr, char *buf)
{
	...
	u16 light = 0;
	reg_data1 = sc080cs_i2c_read(g_sc080cs, 0x516a);
	reg_data2 = sc080cs_i2c_read(g_sc080cs, 0x516b);

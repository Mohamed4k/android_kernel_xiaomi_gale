 ...
 * Filename:
 * ---------
 *	 OV8856_TRULY_FRONT_IImipiraw_sensor.c
 *
 * Project:
 * --------
 *	 ALPS MT6758
...
#include "ov8856_truly_front_iimipiraw_Sensor.h"

#define PFX "OV8856_TRULY_FRONT_II"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV8856_TRULY_FRONT_II_SENSOR_ID,
...
static kal_uint16 ov8856_truly_front_ii_table_write_cmos_sensor(
...
static kal_uint16 read_cmos_sensor_ov8856(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pu_send_cmd[2] = {(char)(addr >> 8), (char)(addr & 0xFF) };
...
static void ov8856_fusion_id_read(void)
{
	int i;
	for (i=0; i<16; i++) {
...
kal_uint16 addr_data_pair_init_ov8856_truly_front_ii[] = {
	0x0103, 0x01,
	0x0302, 0x3c,
	0x0303, 0x01,
	0x031e, 0x0c,
...
{
	LOG_INF("v3 E\n");
	ov8856_truly_front_ii_table_write_cmos_sensor(addr_data_pair_init_ov8856_truly_front_ii,
	  sizeof(addr_data_pair_init_ov8856_truly_front_ii) / sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_ov8856_truly_front_ii[] = {
	0x3501, 0x4c,
	0x3502, 0xe0,
	0x366e, 0x08,
	0x3714, 0x27,
...
#endif
	ov8856_truly_front_ii_table_write_cmos_sensor(addr_data_pair_preview_ov8856_truly_front_ii,
				   sizeof(addr_data_pair_preview_ov8856_truly_front_ii) / sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_30fps_ov8856_truly_front_ii[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
kal_uint16 addr_data_pair_capture_15fps_ov8856_truly_front_ii[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
#endif
	if (currefps == 150) {
		ov8856_truly_front_ii_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_ov8856_truly_front_ii,
	sizeof(addr_data_pair_capture_15fps_ov8856_truly_front_ii) / sizeof(kal_uint16));
	} else {
		ov8856_truly_front_ii_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_ov8856_truly_front_ii,
			       sizeof(addr_data_pair_capture_30fps_ov8856_truly_front_ii) /
			       sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_vga_setting_120fps_ov8856_truly_front_ii[] = {
	0x3501, 0x25,
	0x3502, 0xc0,
	0x366e, 0x08,
	0x3714, 0x29,
...
static void vga_setting_120fps(void)
{
	...
	ov8856_truly_front_ii_table_write_cmos_sensor(addr_data_pair_vga_setting_120fps_ov8856_truly_front_ii,
			sizeof(addr_data_pair_vga_setting_120fps_ov8856_truly_front_ii) /
			 sizeof(kal_uint16));
...
static kal_uint32 open(void)
{
	...
	sensor_init();
	mdelay(10);
	#ifdef OV8856_TRULY_FRONT_IIR1AOTP
...
UINT32 OV8856_TRULY_FRONT_II_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV8856_TRULY_FRONT_II_MIPI_RAW_SensorInit	*/

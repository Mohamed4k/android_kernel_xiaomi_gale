...
/* 2023.06.27 lc lxd add for headset button begin */
#define MEDIA_PREVIOUS_SCAN_CODE 257
#define MEDIA_NEXT_SCAN_CODE 258
/* 2023.06.27 lc lxd add for headset button end */
...
#endif
	/*CR:ALPS08245264 modify MT6358_AUDENC_ANA_CON11 = 0x1c07 2V 500k begain*/
	if (water_r == 0) {
		...
		pmic_write(AUDENC_ANA_CON11,
			pmic_read(AUDENC_ANA_CON11) | 0x1C00);
		pr_debug("%s: register AUDENC_ANA_CON11%x=%x",
			__func__, AUDENC_ANA_CON11, pmic_read(AUDENC_ANA_CON11));
	}
	/*CR:ALPS08245264 modify MT6358_AUDENC_ANA_CON11 = 0x1c07 2V 500k end*/

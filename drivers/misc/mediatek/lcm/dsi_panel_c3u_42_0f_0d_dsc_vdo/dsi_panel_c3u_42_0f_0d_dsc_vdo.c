...
static struct LCM_setting_table init_setting_vdo[] = {
	// power on and display enable
	{0xF0, 2, {0x5A, 0x59}},
	{0xF1, 2, {0xA5, 0xA6}},
	{0xBB, 8, {0x01, 0x02, 0x03, 0x0A, 0x04, 0x13, 0x14, 0x00}},
	{0xC4, 10, {0x04, 0x33, 0xB8, 0x49, 0x00, 0xBC, 0x00, 0xA0, 0x00, 0x09}},
	{0x35, 2, {0x00, 0x00}},
	{0x53, 2, {0x2C, 0x00}},
        {0x5E, 2, {0x00, 0x07}},
	{0xE0, 32, {0x0C, 0x00, 0xB0, 0x0C, 0x00, 0x06, 0x0F, 0x00, 0x0B, 0x04, 0x81, 0x04, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1F, 0x0F, 0x09, 0x92, 0x48, 0x42, 0xE8, 0xFF, 0x10, 0x00, 0x00, 0x00}}, //11bit 13KHz
	//Display_on
	{0x11, 2, {0x00, 0x00}},
	{REGFLAG_DELAY, 100, {}},
	//Sleep_out
...
static void lcm_dfps_int(struct LCM_DSI_PARAMS *dsi)
{
	...
	dfps_params[0].vertical_frontporch = 1280;
	...
	dfps_params[1].vertical_frontporch = 310;
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 310;
...
static void lcm_suspend(void)
{
	if (lcd_reset_keep_high) {
		...
		printk("%s,icnl9917 panel no off end!\n", __func__);
	} else {
	    push_table(NULL, lcm_suspend_setting,
		ARRAY_SIZE(lcm_suspend_setting), 1);
	    printk("%s,icnl9917 panel end!\n", __func__);
	}
}
...
struct LCM_DRIVER dsi_panel_c3u_42_0f_0d_dsc_vdo_lcm_drv = {
	.name = "dsi_panel_c3u_42_0f_0d_dsc_vdo",
